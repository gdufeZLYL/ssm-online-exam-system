...
<head>
    ...
    <!-- paperList页面css -->
    <link rel="stylesheet" href="/resources/static/css/students/scores.css" />
...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <li class="layui-nav-item layui-this"><a href="javascript:void(0);">成绩查询</a></li>
    ...
    <div class="layui-container exam_main_body">
        ...
        <div class="layui-row">
            <div class="layui-col-md12">
                <table lay-even lay-skin="line" class="layui-table" id="t_gradeList">
...
<script src="/resources/static/js/students/scores.js"></script>
